...
class User implements UserInterface
{
    ...
    public function getRolesLogiciels(): ?array
    {
        return $this->roles_logiciels;
    }

    public function setRolesLogiciels(?array $roles_logiciels): self
    {
        $this->roles_logiciels = $roles_logiciels;
